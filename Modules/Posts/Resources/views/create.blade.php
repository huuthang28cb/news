                ...
                <div class="x_content">
                    ...
                    <form action="" method="post" data-parsley-validate
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <textarea class="form-control my-editor" name="content" rows="20" cols="50"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <select id="heard" name="topic_id" class="form-control @error('topic_id') is-invalid @enderror" required>
